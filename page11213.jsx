...
export default function Home() {
  ...
  const [oneLinerData, setOneLinerData] = useState(null);
          ...
          <List style={{ padding: '16px' }}>
            ...
            <ListItemButton
              ...
              style={{
                ...
                backgroundColor: currentTab === 0 ? (darkMode
                  ? 'rgba(115, 139, 255, 0.15)'
                  : 'rgba(67, 97, 238, 0.08)') : 'transparent'
              }}
            >
            ...
            <ListItemButton
              ...
              style={{
                ...
                marginBottom: '8px',
                transition: 'all 0.2s ease',
                // MUI styling handled through the 'selected' prop
              }}
            >
